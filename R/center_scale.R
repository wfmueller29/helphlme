...
#' standard deviation
#' @param ref_df a reference dataset that will be used to acquire the mean and 
...
center_scale <- function(df, vars, center = TRUE, scale = TRUE, ref_df = NULL) {
